...
class MovieSeeder extends Seeder {
	public function run() {
		...
		$movies = array(
			...
			array("name" => "Star Trek Into Darkness", "boxmojo_id" => "startrek12", "release" => new DateTime("5/16/2013")),
			...
			array("name" => "The Hangover Part III", "boxmojo_id" => "hangover3", "release" => new DateTime("5/23/2013")),
			array("name" => "Now You See Me", "boxmojo_id" => "nowyouseeme", "release" => new DateTime("5/31/2013")),
			array("name" => "After Earth", "boxmojo_id" => "1000ae", "release" => new DateTime("5/31/2013")),
